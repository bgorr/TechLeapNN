...
def processing():
    ...
    save_path = '/home/ec2-user/repos/TechLeapNN/output/test_dataset_7b_100_9600.p'
    ...
    save_path = '/home/ec2-user/repos/TechLeapNN/output/training_dataset_7b_100_9600.p'
    processing_client = DataProcessingClient(data_dir=data_dir, save_path=save_path)
    processing_client.build()
    processing_client.run()
